...
class System {
    public:
        ...
        static bool use_random_array;
        static int random_int_array[1000];
        static int next_random_int;
        
        int getNextRandomInt(int min, int max);
        double getNextRandomDouble(double min, double max);
